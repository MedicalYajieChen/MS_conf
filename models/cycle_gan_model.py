...
# from . import netowork_seg as networks
...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(no_dropout=True,norm='instance', netG='resnet_9blocks',netD='n_layers',n_layers_D=3,no_lsgan=True)
        if is_train:
    ...
    def __init__(self, opt):
        ...
        # self.writer = SummaryWriter("./runs/Abdo_experiment_1")
    ...
    def set_input(self, input):
        ...
        # self.A_lb = input['A_label']
        # print('isTrain:',self.isTrain)
        if not self.isTrain:
            self.seg_path = input['seg_path']
        # img_grid = torchvision.utils.make_grid(self.real_A)
        # lb_grid = torchvision.utils.make_grid(self.A_lb)

        # self.writer.add_image("abdo images", img_grid)
        # self.writer.add_image("abdo labels", lb_grid)
